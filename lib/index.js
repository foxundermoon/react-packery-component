...
var propTypes = {
    ...
    imagesLoadedEvent: PropTypes.arrayOf(PropTypes.shape({
...
PackeryComponent = createReactClass({
        ...
        imagesLoaded: function() {
            ...
            var imgLoad = imagesloaded(this.refs[refName]);
            imgLoad.on(
            ...
            var imagesLoadedEvent=this.props.imagesLoadedEvent;
            if(typeof imagesLoadedEvent !== 'undefined' && imagesLoadedEvent !== null){
                if(Array.isArray(imagesLoadedEvent)){
                    for(var i=0; i < imagesLoadedEvent.length; i++){
                        var item=imagesLoadedEvent[i];
                        imgLoad.on(item.name,item.event);
                    }   
                } 
            }
        },
